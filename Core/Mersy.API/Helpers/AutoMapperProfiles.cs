...
namespace Mersy.Api.Helpers
{
    public class AutoMapperProfiles : Profile
    {
        ...
        {
            CreateMap<LotterySale, LotterySaleDTO>().ReverseMap();
            CreateMap<LotterySaleItem, LotterySaleItemsDTO>().ReverseMap();
            CreateMap<Lottery, LotteryDTO>().ReverseMap();
            CreateMap<LotteryFrom, LotteryFromDTO>().ReverseMap();
            CreateMap<LotteryMode, LotteryModeDTO>().ReverseMap();
            CreateMap<LotterySchedule, LotteryScheduleDTO>().ReverseMap();
