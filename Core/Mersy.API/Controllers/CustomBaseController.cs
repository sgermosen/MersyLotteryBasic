...
namespace Mersy.Api.Controllers
{
    public class CustomBaseController : ControllerBase
    {
        ...
        protected async Task<ActionResult<TDTO>> Get<TEntidad, TDTO>(long id) where TEntidad : class, IId
        {
        ...
        protected async Task<ActionResult> Delete<TEntidad>(long id) where TEntidad : class, IId, new()
        {
        ...
        protected async Task<ActionResult> Patch<TEntidad, TDTO>(long id, JsonPatchDocument<TDTO> patchDocument) 
            where TDTO : class
